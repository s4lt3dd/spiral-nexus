...
export const metadata = { title: "My listings · Spiral Nexus" };

// Listings management — relocated here from /dashboard in Slice 4 so /dashboard
// can become the profile home. Functionally unchanged.
