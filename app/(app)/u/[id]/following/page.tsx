// AUTH-GATED route — /u/[id]/following is sign-in-only, matching /u/[id] and
...
import { followCounts, listFollowing, viewerFollowingSet } from "@/lib/follows";
...
export async function generateMetadata({
  ...
  return { title: `Who ${name} follows · Spiral Nexus` };
}
